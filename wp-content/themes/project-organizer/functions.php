...
function project_organizer_main_menu() {
    ?>
    <ul>
        <li><a href="<?php echo admin_url(); ?>post-new.php?post_type=project">Add new project</a></li>
        <li><a href="<?php echo get_post_type_archive_link( 'project' ); ?>">View all project</a></li>
    </ul>
    <?php
}
